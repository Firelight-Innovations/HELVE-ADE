...
Schematify's two predecessor applications, its two former entries, are now
one app rather than pinned tools (see [The stack, end to end](the-stack.md)), so the badge is
