 ...
 * differs between the two apps is which *keys* they name — this one names
 ...
 * mounted app frame today, so a second call would be a second round trip for
 * an answer that this frame has no way to learn has moved.
 */
